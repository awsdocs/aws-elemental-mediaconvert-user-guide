# How AWS Elemental MediaConvert works with IAM<a name="security_iam_service-with-iam"></a>
...
## Identity\-based policies for MediaConvert<a name="security_iam_service-with-iam-id-based-policies"></a>
...
### Identity\-based policy examples for MediaConvert<a name="security_iam_service-with-iam-id-based-policies-examples"></a>
...
## Resource\-based policies within MediaConvert<a name="security_iam_service-with-iam-resource-based-policies"></a>
...
## Policy actions for MediaConvert<a name="security_iam_service-with-iam-id-based-policies-actions"></a>
...
## Policy resources for MediaConvert<a name="security_iam_service-with-iam-id-based-policies-resources"></a>
...
## Policy condition keys for MediaConvert<a name="security_iam_service-with-iam-id-based-policies-conditionkeys"></a>
...
## ACLs in MediaConvert<a name="security_iam_service-with-iam-acls"></a>
...
## ABAC with MediaConvert<a name="security_iam_service-with-iam-tags"></a>
...
## Using temporary credentials with MediaConvert<a name="security_iam_service-with-iam-roles-tempcreds"></a>
...
## Cross\-service principal permissions for MediaConvert<a name="security_iam_service-with-iam-principal-permissions"></a>
...
## Service roles for MediaConvert<a name="security_iam_service-with-iam-roles-service"></a>
...
## Service\-linked roles for MediaConvert<a name="security_iam_service-with-iam-roles-service-linked"></a>
