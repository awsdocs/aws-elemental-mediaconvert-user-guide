...
+ [Setting up a job in AWS Elemental MediaConvert](setting-up-a-job.md)
   ...
   + [Step 1: Specify your input files](specify-input-settings.md)
      + [Generating black video](video-generator.md)
...
+ [Foundational video concepts and related AWS Elemental MediaConvert settings](video-settings.md)
   ...
   + [Padding video with black video frames](video-padding.md)
...
+ [Monitoring AWS Elemental MediaConvert](monitoring-overview.md)
   + [Using EventBridge with AWS Elemental MediaConvert](eventbridge_events.md)
      ...
      + [List of MediaConvert EventBridge events](mediaconvert_event_list.md)
         + [Events with INPUT_INFORMATION status](ev_status_input_information.md)
         + [Events with PROGRESSING status](ev_status_progressing.md)
         + [Events with STATUS_UPDATE status](ev_status_status_update.md)
            + [Adjust the status update interval](adjusting-the-status-update-interval.md)
