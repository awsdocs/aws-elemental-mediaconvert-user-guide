...
1. In the **Output settings** pane, for **Name modifier**, enter a value\.
   ...
   MediaConvert appends the name modifier to the file names that it creates for this output\. Enter a name modifier that will make it easy to identify which files came from which output, such as `-standalone-hi-res`\.
